...
export default function CsignUpThree({ onNext, onBack }) {
  ...
  const handleNextClick = () => {
    if (selectedServices.length === 0 && !otherService) {
      alert("Please select at least one service or specify other services")
      return
    }

    const formData = { selectedServices, otherService }
    ...
    <div className="min-h-screen bg-white p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <div className="relative">
            <div className="w-full h-2 bg-gray-300 rounded-full">
              <div className="w-[75%] h-2 bg-blue-600 rounded-full"></div>
            </div>
          </div>
        </div>
        ...
        <div className="border border-gray-300 rounded-2xl mb-8 bg-white shadow-sm">
          <div className="p-8">
            <h2 className="text-lg font-medium text-black mb-8">Select the services that you do</h2>
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Specify other services you offer"
                value={otherService}
