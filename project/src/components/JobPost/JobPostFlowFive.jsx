...
function JobFlowFive() {
    ...
    <div className="w-80 h-14 left-[342px] top-[173px] absolute bg-white">
        ...
        <div className="w-[491.43px] h-6 left-[-50px] top-0 absolute bg-sky-600 rounded-[20px] border border-black" />
    </div>
    ...
    <div className="w-[686px] h-80 left-[297px] top-[227px] absolute rounded-[20px] outline outline-1 outline-offset-[-1px] outline-zinc-300 overflow-hidden">
        <div className="left-[44px] top-[31px] absolute justify-start text-black text-xl font-normal font-['Inter']">Tell us about your space</div>
        ...
        <div className="left-[103px] top-[116px] absolute justify-start text-black text-xl font-normal font-['Inter']">House</div>
        <div className="left-[221px] top-[116px] absolute justify-start text-black text-xl font-normal font-['Inter']">Apartment</div>
        <div className="left-[381px] top-[116px] absolute justify-start text-black text-xl font-normal font-['Inter']">Condo</div>
        <div className="left-[502px] top-[116px] absolute justify-start text-black text-xl font-normal font-['Inter']">Townhome</div>
